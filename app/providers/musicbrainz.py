...
# A search that normally answers in under a second has nothing useful to say
# after eight, and a hung connection costs the queue far more than a retry does.
REQUEST_TIMEOUT = 8.0

# Total wall-clock one search may spend before giving up on the remaining
# spellings. A refusal is handled by the breaker; this bounds the other failure
# mode, where requests neither succeed nor fail promptly. Without it, timeouts
